    ...
    pages: {
      ...
      tournamentResults: {
        ...
        tournamentStatus: {
          ...
          liveResultsWarningText: 'Results may be temporarily unavailable while rounds are being updated.',
    ...
    pages: {
      ...
      tournamentResults: {
        ...
        tournamentStatus: {
          ...
          liveResultsWarningText: 'Resultat kan tillfälligt vara otillgängliga medan ronder uppdateras.',
